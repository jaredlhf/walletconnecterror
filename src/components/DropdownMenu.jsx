...
import { dcWcUpdateStorage, changeWcUpdateStorage, connectWcUpdateStorage } from "@/algorand/wallet";
                                                ...
                                                {provider.isConnected && !provider.isActive && (
                                                    <Button
                                                        ...
                                                        onClick={ async ()=> {
                                                            ...
                                                            changeWcUpdateStorage(provider.metadata.name);
                                                        }}
                                                ...
                                                {provider.isConnected ? (
                                                    <Button
                                                        ...
                                                        onClick={async () => {
                                                            ...
                                                            dcWcUpdateStorage(provider.metadata.name);
                                                        }}
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={async () => {
                                                            ...
                                                            connectWcUpdateStorage(provider.metadata.name);
                                                        }}
